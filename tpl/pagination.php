...
$links = paginate_links( array(
	...
	'prev_text' => ( '<i class="icon-isak-angles-left1"></i>' ),
	'next_text' => ( '<i class="icon-isak-angles-left"></i>' ),
) );
...
$next_link = get_next_posts_link( esc_html__( 'Next', 'isak' ) );
$prev_link = get_previous_posts_link( esc_html__( 'Previous', 'isak' ) );
$loadmore_text = apply_filters('themesflat/template/loadmore_text',esc_html__('Load More','isak'));

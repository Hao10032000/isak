...
if (class_exists('WP_Customize_Control')) {
	...
	class themesflat_Typography extends WP_Customize_Control {
		...
		public function render_content() {
			$this->titles = array(
				'100'        => esc_html__( 'Thin 100', 'isak' ),
				'100italic'  => esc_html__( 'Thin 100 italic', 'isak' ),
				'200'        => esc_html__( 'Extra-light 200', 'isak' ),
				'200italic'  => esc_html__( 'Extra-light 200 italic', 'isak' ),
				'300'        => esc_html__( 'Light 300', 'isak' ),
				'300italic'  => esc_html__( 'Light 300 italic', 'isak' ),
				'400'        => esc_html__( 'Normal 400', 'isak' ),
				'400italic'  => esc_html__( 'Normal 400 italic', 'isak' ),
				'regular'    => esc_html__( 'Normal 400', 'isak' ),
				'italic'     => esc_html__( 'Normal 400 italic', 'isak' ),
				'500'        => esc_html__( 'Medium 500', 'isak' ),
				'500italic'  => esc_html__( 'Medium 500 italic', 'isak' ),
				'600'        => esc_html__( 'Semi-bold 600', 'isak' ),
				'600italic'  => esc_html__( 'Semi-bold 600 italic', 'isak' ),
				'700'        => esc_html__( 'Bold 700', 'isak' ),
				'700italic'  => esc_html__( 'Bold 700 italic', 'isak' ),
				'800'        => esc_html__( 'Extra-bold 800', 'isak' ),
				'800italic'  => esc_html__( 'Extra-bold 800 italic', 'isak' ),
				'900'        => esc_html__( 'Ultra-bold 900', 'isak' ),
				'900itallic' => esc_html__( 'Ultra-bold 900 italic', 'isak' )
			);

			$this->titles_subsets = array(
				"cyrillic-ext"  => esc_html__("Cyrillic Extended",'isak'),
			    "greek" 		=> esc_html__("Greek",'isak'),
			    "greek-ext"		=>	esc_html__("Greek Extended",'isak'),
			    "latin-ext"		=>	esc_html__("Latin Extended",'isak'),
			    "cyrillic"		=>	esc_html__("Cyrillic",'isak'),
			    "vietnamese"	=>	esc_html__("Vietnamese",'isak'),
			    "latin" 		=> esc_html__("Latin",'isak')
				);
			...
			<div class="themesflat-options-control-inputs">					
				...
				<div class="themesflat-options-control-chosen themesflat-typography-group typography-font">
					<div class="themesflat-options-control-title customize-control-title">
						<label for="<?php  echo esc_attr( $name ) ?>-family"><?php esc_html_e( 'Font Family', 'isak' ) ?></label>
					</div>
					<div class="themesflat-options-control-inputs">
						<select name="<?php  echo esc_attr( $name ) ?>[family]" id="<?php  echo esc_attr( $name ) ?>-family" class="select-choosen" >
							<optgroup label="<?php echo esc_html( 'Google Fonts', 'isak' ) ?>">
				...
				<div class="themesflat-options-control-chosen themesflat-typography-group typography-style">
					<div class="themesflat-options-control-title customize-control-title">
						<label><?php esc_html_e( 'Font Weight & Style', 'isak' ) ?></label>
					</div>
					<div class="themesflat-options-control-inputs">
						<label>
				...
				<?php if ( in_array( 'subsets', $this->fields ) ): ?>
					<div class="themesflat-options-control typography-subsets themesflat-options-control-switcher active">
						<div class="themesflat-options-control-title customize-control-title">
							<label><?php esc_html_e( 'Font subsets', 'isak' ) ?></label>
						</div>
						<div class="themesflat-options-control-inputs">
				...
				<div class="themesflat-typography-group typography-size">
					<div class="themesflat-options-control-title customize-control-title">
						<label for="<?php  echo esc_attr( $name ) ?>-size"><?php esc_html_e( 'Font Size (px)', 'isak' ) ?></label>
					</div>
					<div class="themesflat-options-control-inputs">
				...
				<div class="themesflat-typography-group typography-line_height">
					<div class="themesflat-options-control-title customize-control-title">
						<label for="<?php  echo esc_attr( $name ) ?>-line_height"><?php esc_html_e( 'Line height ( ex: 25px or 1.8 or 150% )', 'isak' ) ?></label>
					</div>
					<div class="themesflat-options-control-inputs">
				...
				<div class="themesflat-typography-group typography-letter_spacing">
					<div class="themesflat-options-control-title customize-control-title">
						<label for="<?php  echo esc_attr( $name ) ?>-letter_spacing"><?php esc_html_e( 'Letter Spacing ( Value in px or em )', 'isak' ) ?></label>
					</div>
					<div class="themesflat-options-control-inputs">
				...
				<div class="themesflat-typography-group themesflat-options-control-color-picker typography-color">
					<div class="themesflat-options-control-title customize-control-title">
						<label><?php esc_html_e( 'Font Color', 'isak' ) ?></label>
					</div>
					<div class="themesflat-options-control-inputs">

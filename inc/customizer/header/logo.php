...
$wp_customize->add_control(
    new WP_Customize_Image_Control(
        ...
        'site_logo',
        array(
           'label'          => esc_html__( 'Upload Your Logo ', 'isak' ),
...
$wp_customize->add_setting(
    'site_logo_white',
    array(
        'default' => themesflat_customize_default('site_logo_white'),
        'sanitize_callback' => 'esc_url_raw',
    )
);    
$wp_customize->add_control(
    new WP_Customize_Image_Control(
        ...
        'site_logo_white',
        array(
           'label'          => esc_html__( 'Upload Your Logo White', 'isak' ),
           'description'    => esc_html__( 'If you don\'t display logo please remove it your website display 
            Site Title default in General', 'isak' ),
           'type'           => 'image',
           'section'        => 'section_logo',
...
$wp_customize->add_control(
    new WP_Customize_Image_Control(
        ...
        'site_logo_mobile',
        array(
           'label'          => esc_html__( 'Upload Your Logo On Mobile', 'isak' ),
           'description'    => esc_html__( 'If you don\'t display logo please remove it your website display 
            Site Title default in General', 'isak' ),
           'type'           => 'image',
           'section'        => 'section_logo',
...
$wp_customize->add_control( new themesflat_BoxControls($wp_customize,
    'logo_controls',
    array(
        'label' => esc_html__( 'Box Controls (px)', 'isak' ),
        'section' => 'section_logo',
        'type' => 'box-controls',
        'priority' => 4
    ))

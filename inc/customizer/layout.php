...
$wp_customize->add_control( 
    ...
    array(
        ...
        'priority'  => 1,
        'label'         => esc_html__('Layout version', 'isak'),
        'choices'   => array(
            'wide'           =>  esc_html__('Wide','isak'),
            'boxed'         =>   esc_html__('Boxed','isak'),
    ))
);  
...
$wp_customize->add_control(
    new themesflat_ColorOverlay(
        ...
        'body_background_color',
        array(
            'label'         => esc_html__('Body Background Color', 'isak'),
            'section'       => 'background_image',
            'priority'      => 2
        )
    )
...
$wp_customize->add_control( new themesflat_BoxControls($wp_customize,
    'content_controls',
    array(
        'label' => esc_html__( 'Content Box Controls (px)', 'isak' ),
        'section' => 'background_image',
        'type' => 'box-controls',
        'priority' => 10
    ))
...
$wp_customize->add_control( 
    ...
    array (
        ...
        'section'   => 'background_image',
        'priority'  => 11,
        'label'         => esc_html__('Page Sidebar Position', 'isak'),
        'choices'   => array (
